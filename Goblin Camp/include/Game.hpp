...
#define SEASON_LENGTH (UPDATES_PER_SECOND * 60 * 5)
...
/*      ITEMS       ITEMS       ITEMS       */
		int CreateItem(Coordinate, ItemType, bool = false, std::vector<boost::weak_ptr<Item> > = std::vector<boost::weak_ptr<Item> >());
